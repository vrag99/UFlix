...
export default function OnboardStepper() {
  ...
  const stepMetadata = [
    { label: "Welcome to UFlix!", img: signupImg },
  ...
  return (
    <div className="flex w-full h-screen gap-4">
      <div className="w-[40%] flex items-center flex-col bg-card justify-center">
        ...
        >
          ...
          {hasCompletedAllSteps && (
            <Card className="bg-background w-[64%] h-[20rem] border-none">
              <CardHeader>
                <CardTitle>You are now ready to use UFlix!</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
                  You have completed all the steps required to use UFlix. Now
